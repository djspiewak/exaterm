            ...
            snapshot: WorkspaceSnapshot {
                sessions: vec![session_snapshot(
                    ...
                    Some(TacticalSynthesis {
                        ...
                        headline: Some(
                            "Parser recovery narrowed to one failing transition.".into(),
                        ),
                    }),
                    true,
                ...
                sessions: vec![
                    session_snapshot(
                        ...
                        Some(TacticalSynthesis {
                            ...
                            headline: Some(
                                "Parser recovery progressing on the focused suite.".into(),
                            ),
                        }),
                        true,
                    ...
                    session_snapshot(
                        ...
                        observation(
                            &["Proceed with deploy? [y/N]", "Waiting for approval."],
                            Some("bash"),
                            Some("bash"),
                        ...
                        Some(TacticalSynthesis {
                            ...
                            tactical_state_brief: Some(
                                "Waiting on explicit operator approval.".into(),
                            ),
                            attention_level: AttentionLevel::Takeover,
                            attention_brief: Some(
                                "Human intervention is required before deploy can continue.".into(),
                            ),
                    ...
                    session_snapshot(
                        ...
                        Some(TacticalSynthesis {
                            ...
                            tactical_state_brief: Some(
                                "Clean checkpoint, waiting for a nudge.".into(),
                            ),
                            attention_level: AttentionLevel::Guide,
